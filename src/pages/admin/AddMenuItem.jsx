...
export default function AddMenuItem() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-extrabold mb-1">Add Menu Item</h1>
      <p className="text-gray-500 text-sm mb-6">Add a new dish to the menu</p>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full mt-1 px-4 py-2.5 rounded-xl border border-gray-200 outline-none focus:border-primary"
            placeholder="Classic pizza with fresh basil and mozzarella"
          />
        </div>
